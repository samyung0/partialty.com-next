...
export default function TechStack() {
  return (
    <section className="mx-auto mt-16 grid max-w-xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
      ...
      >
        <TechStackItem
          imgUrl="/img/nextjs.png"
          category="UI Library & Meta-framework"
          name="React & Next JS"
        />
        <TechStackItem
        ...
        />
        <TechStackItem
          imgUrl="/img/vercel.png"
          category="Hosting Platform"
          name="Vercel Edge"
        />
        <TechStackItem
          imgUrl="/img/mux.png"
          category="Audio Provider"
          name="Mux"
        />
        <TechStackItem
          imgUrl="/img/cloudinary.png"
          category="Image Provider"
          name="Cloudinary"
        />
      </ul>
    </section>
