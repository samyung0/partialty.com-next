...
export default function HeroText() {
  return (
    <section
      className={cn(
        "flex w-[90dvw] flex-col items-center  justify-center gap-6  lg:w-[600px] lg:max-w-[600px]",
      )}
    >
      ...
      <h1 className="relative text-center font-mosk text-2xl tracking-wide md:text-3xl lg:text-4xl">
        ...
        <span className="whitespace-nowrap">
          <span className="highlight-light-lilac dark:highlight-dark-lilac">
            painless
          </span>{" "}
          way
        </span>
      ...
      <p className="text-bold relative text-center text-sm md:leading-5 md:tracking-wider lg:text-base lg:leading-6">
        We got audio courses with{" "}
        <span className="border-b-4 border-custom-yellow">beautiful</span>{" "}
        highlights.
        <br />
        <span className="hidden md:inline">
          No more digging around docs and opening twenty tabs just to learn the
          basics.
          <br />
        </span>
        Dive into our free courses and give us your opinions!{" "}
        <span className="whitespace-nowrap">(づ ◕‿◕ )づ</span>
