        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <div className="flex space-x-6">
              ...
              <a href="https://www.instagram.com/async12/" className="text-gray-500 hover:text-gray-400">
              ...
              <a href="https://github.com/samyung0" className="text-gray-500 hover:text-gray-400">
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-10 md:mt-0">
                <h3 className="text-sm font-semibold leading-6 text-white">Common</h3>
                <ul role="list" className="mt-6 space-y-4">
                  <li>
                    <a
